...
import usersIcon from "../../assets/about5.svg";
import shareIcon from "../../assets/about6.svg";
import mainStudent from "../../assets/about1.svg";
import secondStudent from "../../assets/about2.svg";
import yellowCurve from "../../assets/about4.svg";
import colorBlocks from "../../assets/about3.svg";
const About = () => {
  return (
  ...
  />
   <img
    src={colorBlocks}
    alt=""
    className={styles.colorBlocks}
  />
        <div className={styles.mainImage}>
       <img src={mainStudent} alt="Student learning" />
        </div>

        <div className={styles.secondImage}>
    <img src={secondStudent} alt="Students studying" />
  </div>
